  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      ...
      shippingAddress: this.formBuilder.group({
        street: new FormControl('', [Validators.required, Validators.minLength(6),FormValidators.notOnlyWhitespace]),
        city: new FormControl('', [Validators.required, Validators.minLength(3),FormValidators.notOnlyWhitespace]),
